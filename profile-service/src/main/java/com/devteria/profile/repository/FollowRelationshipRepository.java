...
public interface FollowRelationshipRepository extends Neo4jRepository<UserProfile, String> {
     ...
     */
    @Query("MATCH (a:user_profile {id: $followerId}), (b:user_profile {id: $targetId}) " + "MERGE (a)-[:FOLLOWS]->(b) "
            + "RETURN true")
     ...
     */
    @Query("MATCH (a:user_profile {id: $followerId})-[r:FOLLOWS]->(b:user_profile {id: $targetId}) " + "DELETE r "
            + "RETURN true")
