...
public class InternalUserProfileController {
    ...
    public ApiResponse<Boolean> areFriends(@PathVariable String userid1, @PathVariable String userid2) {
    ...
    public ApiResponse<ArrayList<UserProfile>> getUserFriends(@PathVariable String userId) {
